    ...
    <div className="about-container">
      ...
      <section className="section yellow">
        ...
        <p>
          ...
          <span className="highlight yellow">24-48 hours</span>, collaborating with
          new people and pushing limits - hackathons turn ideas into reality. More than just coding, they teach you how to
          <span className="highlight yellow">think, create and innovate.</span>
        </p>
      </section>
      ...
      <section className="section red">
        ...
        <p>
          When I started, I had no idea where to find hackathons. I had to{" "}
            search through <span className="highlight red">websites, WhatsApp groups and random social media posts
          </span>
      ...
      <section className="section green">
        ...
        <ul>
          <li>
            <span className="highlight green">Lists all hackathons</span> - big
            and small.
          </li>
          <li>
            Helps you{" "}
            <span className="highlight green">sort and discover</span>{" "}
            the best for you.
          </li>
          <li>
            Lets students{" "}
      ...
      <section className="section blue">
        ...
        <p>
          Hackathons have given me so much - learning fast, collaborating
          with my team
      ...
      <section className="section purple">
        ...
        <p>
          ...
          <span className="highlight purple">startups begin</span>, careers take
          shape and lifelong skills develop. Whether you’re a beginner or an experienced hacker,{" "}
      ...
      <section className="section cyan">
        ...
        <p>
          ...
          <span className="highlight cyan">pure CSS</span> - no frameworks or UI
          libraries, because I love{" "}
          <span className="highlight cyan">building from scratch</span>.
